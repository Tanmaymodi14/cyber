...
try:
    ...
    # Fallback for Lambda/direct execution: use /tmp which is writable
    def get_database_path():
        return "/tmp/protecht.db"
...
# Global database instance is intentionally not created at import time to avoid
# failures in serverless environments (e.g., AWS Lambda) where the filesystem
# may be read-only. Use lazy initialization from the application layer instead.
db = None