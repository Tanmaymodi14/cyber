...
Deploys the backend to a simple server and updates CloudFront
"""
...
def create_ec2_instance(session: boto3.Session):
    """Create a simple EC2 instance for the backend"""
    print("🖥️ Creating EC2 instance for backend...")
    ...
    try:
        ...
        try:
            sg_response = ec2.create_security_group(
                GroupName='protecht-backend-sg',
                Description='Security group for proTecht backend API'
            )
            ...
            if 'already exists' in str(e):
                ...
                sg_response = ec2.describe_security_groups(
                    GroupNames=['protecht-backend-sg']
                )
            ...
            TagSpecifications=[
                {
                    ...
                    'Tags': [
                        {'Key': 'Name', 'Value': 'protecht-backend'},
