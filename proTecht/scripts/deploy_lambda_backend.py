...
Deploys the backend as AWS Lambda functions for better reliability
"""
...
'''
        ...
        try:
            response = lambda_client.create_function(
                ...
                Runtime='python3.9',
                Role='arn:aws:iam::957103508532:role/ProTechtBackendRole',
...
def create_api_gateway(session: boto3.Session, lambda_arn: str):
    ...
    try:
        ...
        # Create /api/{proxy+} resource for all API calls
        ...
        # Create ANY method for /api/{proxy+}
    ...
    try:
        ...
        response = cloudfront.create_invalidation(
            ...
            InvalidationBatch={
                ...
                'CallerReference': f"lambda-backend-deploy-{int(time.time())}"
            }
        )
...
def main():
    ...
    try:
        ...
        print(f"\n🎉 Lambda backend deployment completed!")
        ...
        print(f"   CloudFront will route API calls to the Lambda backend")
